      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            We offer a wide range of specialized medical services to meet all your health needs.
          </p>
        </div>
        ...
        >
          {services.map((service, i) => {
            ...
            return (
              <article
                key={service.title}
                className={`bg-surface-variant overflow-hidden rounded-2xl shadow-md hover:shadow-lg hover:scale-101 transition duration-300 ${
        ...
        {/* See more/less button (mobile only) */}
        {hasExtra && (
